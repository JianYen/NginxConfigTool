        ...
        <div>
            ...
            <div class=" button-content" v-if="col==1">
                ...
                <div class="row server-scope2">
                    <div class="col-md-4"><input type="text" placeholder="example.com" v-model="domainInput"
                                                 @input="inputCertificate"></div>
                    <div class="col-md-4"><input id="server-path-input" type="text"
                                                 :placeholder="serverPathPlaceholder + domainInput"
                                                 v-model="serverPathInput" @input="inputServerPath()"></div>
            ...
            <div class="button-content" v-if="col==2">
                <div class="row https-scope">
                    ...
                    <div class="col-md-4">
                        <b-form-checkbox v-model="httpsEnabled" :click="httpSwitch()">enabled</b-form-checkbox>
                    </div>
                ...
                <div :class=httpsConfig>
                    <div class="row https-scope2">
                        ...
                        <div class="col-md-4">
                            <b-form-checkbox v-model="https2Enabled">enabled</b-form-checkbox>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    <div class="row https-scope3">
                        ...
                        <div class="col-md-4">
                            <b-form-checkbox v-model="forceHttpsEnabled">enabled (http://example.com ->
                                https://example.com)
                            </b-form-checkbox>
                        </div>
                        <div class="col-md-4"></div>
                    ...
                    <div class="row https-scope4">
                        ...
                        <div class="col-md-4">
                            <b-form-checkbox v-model="hstsEnabled">enabled</b-form-checkbox>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    <div class="row https-scope5">
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <b-form-checkbox v-model="hstsIncludeSubDomainsEnabled">includeSubDomains</b-form-checkbox>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    <div class="row https-scope6">
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <b-form-checkbox v-model="hstsPreloadEnabled">preload</b-form-checkbox>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
            ...
            <div class="button-content " v-if="col==3">
                <div class="row reverse-proxy-scope1">
                    ...
                    <div class="col-md-10"><label for="reverse-proxy-checkbox"><input type="checkbox"
                                                                                      id="reverse-proxy-checkbox"
                                                                                      v-model="reverseProxyEnabled">enabled</label>
                    </div>
                </div>
                ...
                <div class="row reverse-proxy-scope3">
                    ...
                    <div class="col-md-9"><input type="text" value="http://127.0.0.1:80" v-model="reverseProxyPass">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="config-preview">
            <pre>
                <code>
                    ...
                    <span v-if="hstsEnabled">add_header Strict-Transport-Security "max-age=31536000<label
                            v-if="hstsIncludeSubDomainsEnabled">{{hstsIncludeSubDomains}}</label><label
                            v-if="hstsPreloadEnabled">{{hstsPreload}}</label>" always;</span>
